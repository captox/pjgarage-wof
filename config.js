...
module.exports = {
  ...
  prizes: [
    { id: "none", label: "Better luck next time", shortLabel: "Try Again", amount: 0, weight: 0 },
    { id: "p10", label: "You won ₱10", shortLabel: "₱10", amount: 10, weight: 3000 },
    { id: "p20", label: "You won ₱20", shortLabel: "₱20", amount: 20, weight: 1000 },
    { id: "p50", label: "You won ₱50", shortLabel: "₱50", amount: 50, weight: 5000 },
    ...
    { id: "p5000", label: "JACKPOT! You won ₱5,000", shortLabel: "₱5,000", amount: 5000, weight: 2 }
  ]
};
